...
import { getFractionPoolService, type DomainCandidate } from "@/lib/contracts/fraction-pool"
...
export function VotingInterface({ 
  ...
  const handleVote = async (candidateIndex: number) => {
    ...
    try {
      ...
      const tx = await poolService.voteForCandidate(candidateIndex)
                ...
                <CardContent className="pt-6">
                  <div className="space-y-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="text-xs text-gray-500">
                            ...
                            <code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">
                              {candidate.proposer.slice(0, 6)}...{candidate.proposer.slice(-4)}
                            </code>
                          </div>
                        </div>
                      </div>
                    ...
                    <Button
                      ...
                      disabled={voting || userHasVoted || parseFloat(userContribution) === 0}
                    >
                      {voting ? (
                        <>
